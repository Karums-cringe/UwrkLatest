    ...
    <ul class="flex items-center gap-10 hidden md:flex">
      <template v-if="!isAuthenticated">
        <li class="flex items-center cursor-pointer gap-3 text-gray-600 hover:text-blue-500">
          <button
            @click="openAuthModal"
            class="text-base py-2 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200"
          >
            Login/Register
          </button>
        </li>
      ...
      <template v-else>
        <li class="flex items-center cursor-pointer gap-3 text-gray-600 hover:text-blue-500">
          <router-link to="/favorites" class="py-2 px-4 hover:bg-blue-200 flex items-center gap-3">
            <img src="/heart.svg" alt="Favorite" width="25" height="25" />
            <p class="text-base">Favorite</p>
          </router-link>
          <router-link to="/profile" class="flex items-center gap-3">
            <img src="/Profile.png" alt="Profile" width="30" height="30" />
